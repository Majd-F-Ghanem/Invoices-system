				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  ...
						  <p class="mg-b-0">KaramInvoices monitoring dashboard .</p>
						</div>
					</div>
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
												@php
                                    				$count_all= \App\Invoices::count();
                                    				$count_invoices3= \App\Invoices::where('Value_Status', 3)->count();
                                    				if($count_invoices3 == 0){
                                       					echo $count_invoices3 = 0;
                                    				}
                                    				else{
                                      					 echo $count_invoices1 = $count_invoices3 / $count_all *100 ;
														 echo ('%');  
                                    				}
                                    			@endphp
											</span>
