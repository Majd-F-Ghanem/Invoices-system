<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">برنامح الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المستحدمين</a></li>
							@endcan
							@can('صلاحيات المستخدمين')
							<li><a class="slide-item" href="{{ url('/' . $page='roles') }}">صالحيات المستخدمين</a></li>
							@endcan
						</ul>
					</li>
					@endcan
